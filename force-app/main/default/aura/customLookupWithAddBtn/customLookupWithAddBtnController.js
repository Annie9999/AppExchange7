({
	...
	onfocus: function (component, event, helper) {
	  ...
	  console.log('thers is a getInputkeyWord ::: '+getInputkeyWord);
	  var getSalesName = '';
	...
	clickNewBtn: function (component, event, helper) {
		component.set("v.selectedRecord", null);
		var dependentString = component.get('v.dependentString');
		component.getEvent('onchange').setParams({ "record": null, "lookupVal": '', "oldLookupVal": null,"dependentString": dependentString, "index": {} }).fire();
